...
def load_dataset():
    train_dataset = h5py.File('/content/gdrive/MyDrive/TEST /Residual Networks/datasets/train_signs.h5', "r")
    ...
    test_dataset = h5py.File('/content/gdrive/MyDrive/TEST /Residual Networks/datasets/test_signs.h5', "r")
